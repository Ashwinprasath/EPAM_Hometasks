package org.hometask.designpatterns.builder;
...
public class Bicycle {
	...
	public static void main(String[] args) {
		Bicycle bicycle = new Bicycle.BicycleBuilder().carrier(false).doubleseats(true).doublestands(true).gears(true).getBicycle();
