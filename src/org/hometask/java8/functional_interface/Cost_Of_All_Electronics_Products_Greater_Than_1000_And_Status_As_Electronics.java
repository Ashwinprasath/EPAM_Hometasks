...
public class Cost_Of_All_Electronics_Products_Greater_Than_1000_And_Status_As_Electronics {
	...
	public static void main(String[] args) {
		...
		try (Scanner s = new Scanner(System.in)) {
			...
			Predicate<Products_List> predicate = ab -> ab.category.equals("Electronics")&&ab.price>1000;
